...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-32 md:py-36">
      <h1 className="text-center mb-12 animate-slideUp bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">About Me</h1>
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 mx-auto rounded-full overflow-hidden border-4 border-blue-500 shadow-lg animate-fadeIn">
            <div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
              <Image
                ...
                height={100} // or preferred height
                priority
              />
            </div>
          </div>
        ...
        <div className="md:w-2/3 space-y-6 animate-fadeIn" style={{ animationDelay: "0.3s" }}>
          ...
          <p className="text-slate-600 dark:text-slate-300">
            ...
            in computer science and a love for problem-solving, I enjoy turning
          ...
          <p className="text-slate-600 dark:text-slate-300">
            I specialize in front-end development with React and Next.js, but I'm
            also comfortable working across the full stack. I'm passionate about
            accessibility, performance, and creating seamless user experiences.
          </p>
        </div>
      </div>
    </div>
