...
export const experiences: Experience[] = [
  {
    ...
    company: "Konnect Craft",
    period: "Oct 2025 - present",
    description:
      "Added minor feature in exisiting project built in HONO and React. Learned professional code standard and good practice guided by senior developers. Also worked on automated testing with playwright with different test cases.",
  },
  {
